        ...
        .directive('ngDrop', ['$parse', '$timeout', '$window', 'ngDraggable', function ($parse, $timeout, $window, ngDraggable) {
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var ngDropHitCheck = $parse(attrs.ngDropHitCheck);
                    ...
                    var onDragStart = function(evt, obj) {
                        ...
                        isTouching(obj.x,obj.y,obj.element,obj);
                    ...
                    var onDragEnd = function (evt, obj) {
                        ...
                        if (isTouching(obj.x, obj.y, obj.element,obj)) {
                    ...
                    var isTouching = function(mouseX, mouseY, dragElement, obj) {
                        var touching= hitTest(mouseX, mouseY);
                        if (touching) {
                            if (ngDropHitCheck) {
                                touching = ngDropHitCheck(scope, {$data: obj.data, $event: obj});
                            }
                        }
